...
#pragma resource "*.dfm"
TFrmSystemCenterTeaching *FrmSystemCenterTeaching;
...
//---------------------------------------------------------------------------
__fastcall TFrmSystemCenterTeaching::TFrmSystemCenterTeaching(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFrmSystemCenterTeaching::FormShow(TObject *Sender)
{
...
void __fastcall TFrmSystemCenterTeaching::BtnTeachStart1Click(TObject *Sender)
{
	if(_nEmgValue != 1)
	{
...
//---------------------------------------------------------------------------
void TFrmSystemCenterTeaching::BtncheckStatus(bool bValue)
{
    for (int i= 0; i< _TEACHING_STEP_COUNT_; i++)
    {
        TPanel *ClonePanel = (TPanel *)FindComponent("PanelNextStep"+IntToStr(i +1 ));
...
void __fastcall TFrmSystemCenterTeaching::PageCtrlTeachingChange(TObject *Sender)
{
	LabelActiveCaption->Caption = "STAGE CENTER TEACHING :  " + IntToStr(PageCtrlTeaching->ActivePageIndex +1) + " / 3" ;
}
//---------------------------------------------------------------------------

void __fastcall TFrmSystemCenterTeaching::BtnStep1Click(TObject *Sender)
{
...
void __fastcall TFrmSystemCenterTeaching::BtnTeachNext2Click(TObject *Sender)
{
	if(_nEmgValue != 1)
	{
...
void __fastcall TFrmSystemCenterTeaching::FeedbackTimerTimer(TObject *Sender)
{
...
void __fastcall TFrmSystemCenterTeaching::BtnTeachNext3Click(TObject *Sender)
{
	this->Close();
}
//---------------------------------------------------------------------------

void __fastcall TFrmSystemCenterTeaching::BtnSaveItemClick(TObject *Sender)
{
	int nXValue = 60 + (2* _nStageSelectIndex);
	int nYValue = 61 + (2* _nStageSelectIndex);
	...
	if(EditXValue->Text != "" && EditYValue->Text != "")
    {
        ...
        _nStepSelectIndex =   (_nStageSelectIndex*10) +  105;
        nWriteCommunicationDM(_nStepSelectIndex ,  _TEACHING_COMMAND_VALUE_);
	}
}
//---------------------------------------------------------------------------

void __fastcall TFrmSystemCenterTeaching::TabSheet3Show(TObject *Sender)
{
	int nXValue = 60 + (2* _nStageSelectIndex);
	int nYValue = 61 + (2* _nStageSelectIndex);
