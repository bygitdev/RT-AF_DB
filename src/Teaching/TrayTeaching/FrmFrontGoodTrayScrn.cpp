...
#pragma resource "*.dfm"
TFrmFrontGoodTray *FrmFrontGoodTray;
...
//---------------------------------------------------------------------------
__fastcall TFrmFrontGoodTray::TFrmFrontGoodTray(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFrmFrontGoodTray::FormShow(TObject *Sender)
{
...
void __fastcall TFrmFrontGoodTray::BtnTeachStart1Click(TObject *Sender)
{
	if(_nEmgValue != 1)
	{
...
//---------------------------------------------------------------------------
void TFrmFrontGoodTray::BtncheckStatus(bool bValue)
{
    for (int i= 0; i< _TEACHING_STEP_COUNT_; i++)
    {
        TPanel *ClonePanel = (TPanel *)FindComponent("PanelNextStep"+IntToStr(i +1 ));
...
void __fastcall TFrmFrontGoodTray::BtnStep1Click(TObject *Sender)
{
...
void __fastcall TFrmFrontGoodTray::BtnTeachNext2Click(TObject *Sender)
{
	if(_nEmgValue != 1)
	{
...
void __fastcall TFrmFrontGoodTray::FeedbackTimerTimer(TObject *Sender)
{
...
void __fastcall TFrmFrontGoodTray::BtnSaveItemClick(TObject *Sender)
{
	int nXValue = 210 + (2* _nStageSelectIndex);
	int nYValue = 211 + (2* _nStageSelectIndex);
	...
	if(EditXValue->Text != "" && EditYValue->Text != "")
    {
        ...
        _nStepSelectIndex =   (_nStageSelectIndex*10) +  405;
        nWriteCommunicationDM(_nStepSelectIndex ,  _TEACHING_COMMAND_VALUE_);
	}
}
//---------------------------------------------------------------------------

void __fastcall TFrmFrontGoodTray::TabSheet3Show(TObject *Sender)
{
	int nXValue = 210 + (2* _nStageSelectIndex);
	int nYValue = 211 + (2* _nStageSelectIndex);
...
void __fastcall TFrmFrontGoodTray::BtnTeachNext3Click(TObject *Sender)
{
	this->Close();
}
//---------------------------------------------------------------------------

void __fastcall TFrmFrontGoodTray::PageCtrlTeachingChange(TObject *Sender)
{
