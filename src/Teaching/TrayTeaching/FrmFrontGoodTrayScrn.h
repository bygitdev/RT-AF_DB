...
#ifndef FrmFrontGoodTrayScrnH
#define FrmFrontGoodTrayScrnH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFrmFrontGoodTray : public TForm
{
...
public:		// User declarations
	__fastcall TFrmFrontGoodTray(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFrmFrontGoodTray *FrmFrontGoodTray;
//---------------------------------------------------------------------------
#endif
