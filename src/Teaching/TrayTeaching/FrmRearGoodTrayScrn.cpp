...
#pragma resource "*.dfm"
TFrmRearGoodTray *FrmRearGoodTray;
...
//---------------------------------------------------------------------------
__fastcall TFrmRearGoodTray::TFrmRearGoodTray(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFrmRearGoodTray::FormShow(TObject *Sender)
{
...
void __fastcall TFrmRearGoodTray::BtnTeachStart1Click(TObject *Sender)
{
	if(_nEmgValue != 1)
	{
...
void __fastcall TFrmRearGoodTray::BtnStep1Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void TFrmRearGoodTray::BtncheckStatus(bool bValue)
{
    for (int i= 0; i< _TEACHING_STEP_COUNT_; i++)
    {
        TPanel *ClonePanel = (TPanel *)FindComponent("PanelNextStep"+IntToStr(i +1 ));
...
void __fastcall TFrmRearGoodTray::BtnTeachNext2Click(TObject *Sender)
{
	if(_nEmgValue != 1)
	{
...
void __fastcall TFrmRearGoodTray::FeedbackTimerTimer(TObject *Sender)
{
...
void __fastcall TFrmRearGoodTray::BtnTeachNext3Click(TObject *Sender)
{
	this->Close();
}
//---------------------------------------------------------------------------

void __fastcall TFrmRearGoodTray::BtnSaveItemClick(TObject *Sender)
{
	int nXValue = 200 + (2* _nStageSelectIndex);
	int nYValue = 201 + (2* _nStageSelectIndex);
...
void __fastcall TFrmRearGoodTray::TabSheet3Show(TObject *Sender)
{
	int nXValue = 200 + (2* _nStageSelectIndex);
	int nYValue = 201 + (2* _nStageSelectIndex);
...
void __fastcall TFrmRearGoodTray::PageCtrlTeachingChange(TObject *Sender)
{
