...
#ifndef FrmRejectTrayTeachingScrnH
#define FrmRejectTrayTeachingScrnH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFrmRejectTrayTeaching : public TForm
{
...
public:		// User declarations
	__fastcall TFrmRejectTrayTeaching(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFrmRejectTrayTeaching *FrmRejectTrayTeaching;
//---------------------------------------------------------------------------
#endif
