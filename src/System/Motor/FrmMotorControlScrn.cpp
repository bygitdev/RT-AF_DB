...
bool    TFrmMotorControl::MtrData_SaveDB()
{
	...
	MainForm->MachineHistoryData("Motor Data Max Value : " + FloatToStr(MaxValue));
	MainForm->MachineHistoryData("Motor Data Min Value : " + FloatToStr(MinValue));
	MainForm->MachineHistoryData("Motor Data Update Value : " +FloatToStr(SelectValue));
