object FrmUseSkip: TFrmUseSkip
  ...
  object CurvyPanel1: TCurvyPanel
    ...
    object UseSkipGrid: TStringGrid
      Left = 9
      Top = 9
      Width = 681
      Height = 618
      ...
      ParentFont = False
      TabOrder = 1
      OnDblClick = UseSkipGridDblClick
      OnDrawCell = UseSkipGridDrawCell
      ColWidths = (
        40
        204
        81
  ...
  object UseSkipTimer: TTimer
    Enabled = False
    Interval = 500
    OnTimer = UseSkipTimerTimer
    Left = 216
    Top = 656
  end
end
