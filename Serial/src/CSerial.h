...
#ifdef SERIAL_STATIC
	#define SERIAL_DLLINTERFACE 
#else
	#ifdef SERIAL_EXPORTS
	#define SERIAL_DLLINTERFACE __declspec(dllexport)
	#else
	#define SERIAL_DLLINTERFACE __declspec(dllimport)
	#endif
#endif
...
#ifdef __BORLANDC__
        #define _RPTF0(rptno, msg) OutputDebugString(msg);
        #define _RPTF2(rptno, msg, arg1, arg2) OutputDebugString(msg);
#endif


        class SERIAL_DLLINTERFACE  CSerial
        {
        // Class enumerations
        public:
            // Communication event
        ...
        public:
            ...
            // this method to setup whether to use blocking or non-blocking
