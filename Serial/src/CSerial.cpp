...
#pragma warning(disable: 4127)
    ...
    namespace Serial
    {
        ...
        CSerial::~CSerial ()
        {
            ...
            {
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::~CSerial - Serial port not closed\n"));
        ...
        LONG CSerial::Open (LPCTSTR lpszDevice, DWORD dwInQueue, DWORD dwOutQueue, bool fOverlapped)
        {
            ...
            if (m_hFile)
            {
				...
				_RPTF0(_CRT_WARN,_T("CSerial::Open - Port already opened\n"));
                return m_lLastError;
            }
            ...
            if (m_hFile == INVALID_HANDLE_VALUE)
            {
				...
				_RPTF0(_CRT_WARN,_T("CSerial::Open - Unable to open port\n"));
				return m_lLastError;
            }
            ...
            if (fOverlapped)
            {
                ...
                if (m_hevtOverlapped == 0)
                {
                    ...
                    m_lLastError = ::GetLastError();
					_RPTF0(_CRT_WARN,_T("CSerial::Open - Unable to create event\n"));
            ...
            if (dwInQueue || dwOutQueue)
            {
                ...
                if (!::SetupComm(m_hFile,dwInQueue,dwOutQueue))
                {
					...
					_RPTF0(_CRT_WARN,_T("CSerial::Open - Unable to setup the COM-port\n"));
            ...
            if (::GetDefaultCommConfig(lpszDevice,&commConfig,&dwSize))
            {
                ...
                {
                    // Display a warning
					_RPTF0(_CRT_WARN,_T("CSerial::Open - Unable to set default communication configuration.\n"));
				}
			}
			else
			{
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::Open - Unable to obtain default communication configuration.\n"));
            }
        ...
        LONG CSerial::Close (void)
        {
            ...
            {
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::Close - Method called when device is not open\n"));
                return m_lLastError;
            }
        ...
        LONG CSerial::Setup (EBaudrate eBaudrate, EDataBits eDataBits, EParity eParity, EStopBits eStopBits)
        {
            ...
            if (m_hFile == 0)
            {
				...
				_RPTF0(_CRT_WARN,_T("CSerial::Setup - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::Setup - Unable to obtain DCB information\n"));
                return m_lLastError;
            }
            ...
            if (!::SetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::Setup - Unable to set DCB information\n"));
                return m_lLastError;
            }
        ...
        LONG CSerial::SetEventChar (BYTE bEventChar, bool fAdjustMask)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::SetEventChar - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetEventChar - Unable to obtain DCB information\n"));
                return m_lLastError;
            }
            ...
            if (!::SetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetEventChar - Unable to set DCB information\n"));
				return m_lLastError;
            }
        ...
        LONG CSerial::SetMask (DWORD dwEventMask)
        {
            ...
            if (m_hFile == 0)
            {
				...
				// Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::SetMask - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!::SetCommMask(m_hFile,dwEventMask))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetMask - Unable to set event mask\n"));
                return m_lLastError;
            }
        ...
        LONG CSerial::WaitEvent (LPOVERLAPPED lpOverlapped, DWORD dwTimeout)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::WaitEvent - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!m_hevtOverlapped && (lpOverlapped || (dwTimeout != INFINITE)))
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::WaitEvent - Overlapped I/O is disabled, specified parameters are illegal.\n"));
                return m_lLastError;
            }
            ...
            if (!::WaitCommEvent(m_hFile,LPDWORD(&m_eEvent),lpOverlapped))
            {
                ...
                if (lLastError != ERROR_IO_PENDING)
                {
                    ...
                    // Issue an error and quit
					_RPTF0(_CRT_WARN,_T("CSerial::WaitEvent - Unable to wait for COM event\n"));
                    return m_lLastError;
                }
                ...
                if (lpOverlapped == &ovInternal)
                {
                    ...
                    default:
                        ...
                        // Issue an error and quit
						_RPTF0(_CRT_WARN,_T("CSerial::WaitEvent - Unable to wait until COM event has arrived\n"));
                        return m_lLastError;
                    }
                }
            }
        ...
        LONG CSerial::SetupHandshaking (EHandshake eHandshake)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::SetupHandshaking - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetupHandshaking - Unable to obtain DCB information\n"));
                return m_lLastError;
            }
            ...
            if (!::SetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetupHandshaking - Unable to set DCB information\n"));
                return m_lLastError;
            }
        ...
        LONG CSerial::SetupReadTimeouts (EReadTimeout eReadTimeout)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::SetupReadTimeouts - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!::GetCommTimeouts(m_hFile,&cto))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetupReadTimeouts - Unable to obtain timeout information\n"));
                return m_lLastError;
            }
            ...
            if (!::SetCommTimeouts(m_hFile,&cto))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::SetupReadTimeouts - Unable to set timeout information\n"));
                return m_lLastError;
            }
        ...
        CSerial::EBaudrate CSerial::GetBaudrate (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetBaudrate - Device is not opened\n"));
                return EBaudUnknown;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetBaudrate - Unable to obtain DCB information\n"));
                return EBaudUnknown;
            }
        ...
        CSerial::EDataBits CSerial::GetDataBits (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetDataBits - Device is not opened\n"));
                return EDataUnknown;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetDataBits - Unable to obtain DCB information\n"));
                return EDataUnknown;
            }
        ...
        CSerial::EParity CSerial::GetParity (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetParity - Device is not opened\n"));
                return EParUnknown;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetParity - Unable to obtain DCB information\n"));
                return EParUnknown;
            }
        ...
        CSerial::EStopBits CSerial::GetStopBits (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetStopBits - Device is not opened\n"));
                return EStopUnknown;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetStopBits - Unable to obtain DCB information\n"));
                return EStopUnknown;
            }
        ...
        DWORD CSerial::GetEventMask (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetEventMask - Device is not opened\n"));
                return 0;
            }
        ...
        BYTE CSerial::GetEventChar (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetEventChar - Device is not opened\n"));
                return 0;
            }
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetEventChar - Unable to obtain DCB information\n"));
                return 0;
            }
        ...
        CSerial::EHandshake CSerial::GetHandshaking (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetHandshaking - Device is not opened\n"));
            ...
            if (!::GetCommState(m_hFile,&dcb))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetHandshaking - Unable to obtain DCB information\n"));
                return EHandshakeUnknown;
            }
        ...
        LONG CSerial::Write (const void* pData, size_t iLen, DWORD* pdwWritten, LPOVERLAPPED lpOverlapped, DWORD dwTimeout)
        {
            ...
            *pdwWritten = 0;
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::Write - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!m_hevtOverlapped && (lpOverlapped || (dwTimeout != INFINITE)))
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::Write - Overlapped I/O is disabled, specified parameters are illegal.\n"));
                return m_lLastError;
            }
            ...
            if (!::WriteFile(m_hFile,pData,iLen,pdwWritten,lpOverlapped))
            {
                ...
                if (lLastError != ERROR_IO_PENDING)
                {
                    ...
                    // Issue an error and quit
					_RPTF0(_CRT_WARN,_T("CSerial::Write - Unable to write the data\n"));
                    return m_lLastError;
                }
                ...
                if (lpOverlapped == &ovInternal)
                {
                    ...
                    case WAIT_OBJECT_0:
                        ...
                        if (!::GetOverlappedResult(m_hFile,lpOverlapped,pdwWritten,FALSE))
                        {
							...
							_RPTF0(_CRT_WARN,_T("CSerial::Write - Overlapped completed without result\n"));
                            return m_lLastError;
                        }
                        break;
                    ...
                    default:
                        ...
                        // Issue an error and quit
						_RPTF0(_CRT_WARN,_T("CSerial::Write - Unable to wait until data has been sent\n"));
                        return m_lLastError;
                    }
                }
            }
        ...
        LONG CSerial::Read (void* pData, size_t iLen, DWORD* pdwRead, LPOVERLAPPED lpOverlapped, DWORD dwTimeout)
        {
            ...
            *pdwRead = 0;
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::Read - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!m_hevtOverlapped && (lpOverlapped || (dwTimeout != INFINITE)))
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::Read - Overlapped I/O is disabled, specified parameters are illegal.\n"));
                return m_lLastError;
            }
            ...
            if (!::ReadFile(m_hFile,pData,iLen,pdwRead,lpOverlapped))
            {
                ...
                if (lLastError != ERROR_IO_PENDING)
                {
                    ...
                    // Issue an error and quit
					_RPTF0(_CRT_WARN,_T("CSerial::Read - Unable to read the data\n"));
                    return m_lLastError;
                }
                ...
                if (lpOverlapped == &ovInternal)
                {
                    ...
                    case WAIT_OBJECT_0:
                        ...
                        if (!::GetOverlappedResult(m_hFile,lpOverlapped,pdwRead,FALSE))
                        {
							...
							_RPTF0(_CRT_WARN,_T("CSerial::Read - Overlapped completed without result\n"));
                            return m_lLastError;
                        }
                        break;
                    ...
                    default:
                        ...
                        // Issue an error and quit
						_RPTF0(_CRT_WARN,_T("CSerial::Read - Unable to wait until data has been read\n"));
                        return m_lLastError;
                    }
                }
            }
        ...
        LONG CSerial::Purge()
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::Purge - Device is not opened\n"));
                return m_lLastError;
            }
            ...
            if (!::PurgeComm(m_hFile, PURGE_TXABORT | PURGE_RXABORT |PURGE_TXCLEAR | PURGE_RXCLEAR))
            {
                // Set the internal error code
                m_lLastError = ::GetLastError();
				_RPTF0(_CRT_WARN,_T("CSerial::Purge - Overlapped completed without result\n"));
            }
        ...
        LONG CSerial::Break (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::Break - Device is not opened\n"));
                return m_lLastError;
            }
        ...
        CSerial::EEvent CSerial::GetEventType (void)
        {
            ...
            if ((m_eEvent & m_dwEventMask) == 0)
				_RPTF2(_CRT_WARN,_T("CSerial::GetEventType - Event %08Xh not within mask %08Xh.\n"), m_eEvent, m_dwEventMask);
		#endif
        ...
        CSerial::EError CSerial::GetError (void)
        {
            ...
            if (m_hFile == 0)
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetError - Device is not opened\n"));
            ...
            if (!::ClearCommError(m_hFile,&dwErrors,0))
            {
                ...
                // Issue an error and quit
				_RPTF0(_CRT_WARN,_T("CSerial::GetError - Unable to obtain COM status\n"));
				return EErrorUnknown;
            }
        ...
        bool CSerial::GetCTS (void)
        {
            ...
            if (!::GetCommModemStatus(m_hFile,&dwModemStat))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetCTS - Unable to obtain the modem status\n"));
                return false;
            }
        ...
        bool CSerial::GetDSR (void)
        {
            ...
            if (!::GetCommModemStatus(m_hFile,&dwModemStat))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetDSR - Unable to obtain the modem status\n"));
                return false;
            }
        ...
        bool CSerial::GetRing (void)
        {
            ...
            if (!::GetCommModemStatus(m_hFile,&dwModemStat))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetRing - Unable to obtain the modem status"));
                return false;
            }
        ...
        bool CSerial::GetRLSD (void)
        {
            ...
            if (!::GetCommModemStatus(m_hFile,&dwModemStat))
            {
                ...
                // Display a warning
				_RPTF0(_CRT_WARN,_T("CSerial::GetRLSD - Unable to obtain the modem status"));
                return false;
            }
